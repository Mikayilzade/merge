...
export const UNIT_DEFS = {
  ...
  shade: {
    ...
    abilityDescription: 'Предпочитает хрупкие цели. Удар из гекса прямо за спиной цели гарантированно критует. Наносит 155% урона врагам ниже 32% здоровья.',
    description: 'Очень быстрый убийца задней линии. Ищет хрупкие цели, а окружение может открыть ему спину противника.',
...
export const ARENA_SKINS = {
  violet: { id: 'violet', name: 'Аметистовый разлом', price: 0, icon: '✦', description: 'Холодный фиолетовый свет и кристаллы Арканы.' },
  ember: { id: 'ember', name: 'Кузня Алого Осколка', price: 900, icon: '🔥', description: 'Тёплая кузня, искры и раскалённые трещины.' },
  verdant: { id: 'verdant', name: 'Пепельный сад', price: 1200, icon: '🌿', description: 'Зелёное свечение леса, который выжил после Раскола.' }
};
...
export const STAT_HELP = {
  ...
  moveSpeed: { name: 'Скорость движения', icon: '➜', description: 'Как быстро боец переходит на соседний свободный гекс. Не увеличивает частоту атак.' },
  range: { name: 'Дальность', icon: '◎', description: 'Максимальная дистанция действия в гексах: 1 — соседняя клетка, дальники работают с 3–5 гексов.' },
