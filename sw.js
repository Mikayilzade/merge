...
const CORE = [
  ...
  './js/ui/bootstrap.js?v=0.4.0','./js/ui/battle-report.js?v=0.4.0','./js/v032-ui.js?v=0.4.0','./js/v032-formation.js?v=0.4.0','./js/v032-combat-ui.js?v=0.4.0','./js/v033-state.js?v=0.4.0','./js/v034-ui.js?v=0.4.0'
];
